...
intrinsèques qui seraient dépendantes de l'architecture. (réf: \hyperref[org877d9dc]{2})
...
\label{sec:org99f88d3}
\subsection{Point git}
\label{sec:org01b3f12}
\subsubsection{Rebasage}
\label{sec:org226958e}
...
et 3 bit de pseudo-mantisse). Prenons \hyperref[orgc9d03be]{la formule du standard \textbf{IEEE754}} qui
est:
...
\label{sec:orgeaa77a6}
\begin{enumerate}
\item Cas des nombres normaux
\label{sec:org0a5f4d0}
...
\label{sec:orgababd85}
\subsubsection{Explication}
\label{sec:org1b8da6e}
\begin{enumerate}
\item But
\label{sec:org0f0ae5a}
...
\label{sec:org7a972c5}

Voir les \hyperref[org2ca3c78]{figures 11 et +} pour les résultats de la machine qui tourne sur un
Linux Natif.

\begin{enumerate}
\item Ecart type
\label{sec:org2e6d0a6}

Bien que nous utilisions une machine virtuelle, nous pouvons voir que les
résultats sont assez stable excepté 3 ou 4 fois. (voir les figures \hyperref[orgec011d2]{3}, \hyperref[orgfdb1e32]{5} et \hyperref[org885101e]{6})
...
\item Backend IEEE
\label{sec:orgb52c3f4}

Pour ce qui concerne le backend \textbf{ieee} (voir la figure \hyperref[org47b72af]{2}), nous avons une
...
\item Backend VPREC
\label{sec:org665eb7a}

Pour ce qui concerne le backend \textbf{vprec} (voir la figure \hyperref[orgec069ab]{4}), nous pouvons
...
\label{sec:orge76120f}
\subsection{Introduction}
\label{sec:org6c122a6}
...
de la compilation du benchmark BT. (voir la \hyperref[orga925e7e]{figure 8})

Après avoir compilé et exécute le benchmark BT, la vectorisation au niveau du programme est représentée
dans la figure suivante. (voir la \hyperref[orgadca7f1]{figure 9})
...
Les figures suivantes représentent l'évaluation de la vectorisation au niveau du benchmark BT avec 8 threads. (voir la \hyperref[org2fce3c9]{figure 10})

\subsection{Conclusion}
\label{sec:org0d50d5d}
...
\section{Référence}
\label{sec:orgc8854f6}

\begin{enumerate}
\item \label{orgc9d03be} Aide Mémoire sur le standard IEEE754, Pablo de Oliveira Castro,
\url{https://sifflez.org/lectures/archi-ord/AideMemoireIEEE754.pdf}
\item \label{org877d9dc} Extension des vecteurs de Clang, Clang / LLVM,
...
\section{Annexe}
\label{sec:org97bd7ef}

\label{org55ead36}
\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/special_case.png}
\caption{\label{fig:orgaa3395d}Rappel des cas spéciaux}
\end{figure}
...
\caption{\label{fig:org2a4ee4c}Résultat du backend IEEE (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org475c67f}Ecart type du backend IEEE (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org5125a3c}Résultat du backend VPREC (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org204a3d2}Ecart type du backend VPREC avec des nombres normaux (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org7d73cab}Ecart type du backend VPREC avec des nombres dénormaux (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org3163e50}Résultat du backend VPREC entre l'implémentation sérial et l'implémentation vectorielle des nombres normaux (Machine Virtuelle)}
\end{figure}
...
\caption{\label{fig:org5f5e5cd}Rappel des cas spéciaux}
\end{figure}
...
\caption{\label{fig:orgf06a64f}Vectorisation au niveau du benckmark BT}
\end{figure}
...
\caption{\label{fig:orgf253173}Vectorisation au niveau du benckmark BT}
\end{figure}
...
\caption{\label{fig:orgeaa9d4f}Résultat du backend IEEE (Linux Natif)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/laptop_ieee_stddev.png}
\caption{\label{fig:org46fbf3a}Ecart type du backend IEEE (Linux Natif)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/laptop_vprec.png}
\caption{\label{fig:org5b1b8c2}Résultat du backend VPREC (Linux Natif)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/laptop_vprec_normal_stddev.png}
\caption{\label{fig:org9fae626}Ecart type du backend VPREC avec des nombres normaux (Linux Natif)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/laptop_vprec_denormal_stddev.png}
\caption{\label{fig:org88a2bf1}Ecart type du backend VPREC avec des nombres dénormaux (Linux Natif)}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=450px]{../ressources/laptop_vprec_serial_vs_vector.png}
\caption{\label{fig:orga12742d}Résultat du backend VPREC entre l'implémentation sérial et l'implémentation vectorielle des nombres normaux (Linux Natif)}
\end{figure}
\end{document}
