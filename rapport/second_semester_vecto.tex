...
intrinsèques qui seraient dépendantes de l'architecture. (réf: \hyperref[org5643b17]{2})
...
\label{sec:org795af49}
\subsection{Point git}
\label{sec:orgfcb605b}
\subsubsection{Rebasage}
\label{sec:org9c3defb}
...
et 3 bit de pseudo-mantisse). Prenons \hyperref[orgbf38357]{la formule du standard \textbf{IEEE754}} qui
est:
...
\label{sec:org0746eaf}
\begin{enumerate}
\item Cas des nombres normaux
\label{sec:orgb72c88c}
...
\label{sec:orge7f795f}
\subsubsection{Explication}
\label{sec:orgfe19e23}
\begin{enumerate}
\item But
\label{sec:org3e64f7e}
...
\label{sec:orgf8b8a4e}
\begin{enumerate}
\item Ecart type
\label{sec:org0416403}

Bien que nous utilisions une machine virtuelle, nous pouvons voir que les
résultats sont assez stable excepté 3 ou 4 fois. (voir les figures \hyperref[org57a593b]{3}, \hyperref[orgaa7d854]{5} et \hyperref[orge0195c2]{6})

\item Backend IEEE
\label{sec:org804ed7f}

Pour ce qui concerne le backend \textbf{ieee} (voir la figure \hyperref[orged2c8aa]{2}), nous avons une
...
\item Backend VPREC
\label{sec:org77f37f1}

Pour ce qui concerne le backend \textbf{vprec} (voir la figure \hyperref[org94461de]{4}), nous pouvons
...
\label{sec:org586c988}
\subsection{Introduction}
\label{sec:org755269b}
...
de la compilation du benchmark BT. (voir la \hyperref[org787b9c2]{figure 8})

Après avoir compilé et exécute le benchmark BT, la vectorisation au niveau du programme est représentée
dans la figure suivante. (voir la \hyperref[orgd270c02]{figure 9})
...
Les figures suivantes représentent l'évaluation de la vectorisation au niveau du benchmark BT avec 8 threads. (voir la \hyperref[orga01e0b3]{figure 10})
