...
* Annexe
  ...
  <<figure 3>>
  #+CAPTION: Ecart type du backend IEEE
  ...
  <<figure 5>>
  #+CAPTION: Ecart type du backend VPREC avec des nombres normaux
  #+NAME: fig:stddev_vm_vprec_normal_stddev
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_vprec_normal_stddev.png]]

  <<figure 6>>
  #+CAPTION: Ecart type du backend VPREC avec des nombres dénormaux
