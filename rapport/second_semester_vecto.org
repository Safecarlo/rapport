...
**** Avant de faire les mesures de performances
     ...
     l'ordinateur portable nous n'avons pas *AVX*). De plus nous avons affecté
...
***** Ecart type
      ...
      ~stddev = sqrt(var) = sqrt((sum((x_i - m)^2)) / n)~

      Où:
      - *stddev* est l'écart type
      - *var* est la variance
      - *sqrt* est la racine carré
      - *sum* est le symbole somme en mathématiques
      - *x_i* est l'élément i du tableau
      - *m* est la moyenne
...
*** Résultat
    ...
    Voir les [[figure 11][figures 11 et +]] pour les résultats de la machine qui tourne sur un
    Linux Natif.
     
**** Ecart type
     
     Bien que nous utilisions une machine virtuelle, nous pouvons voir que les
     résultats sont assez stable excepté 3 ou 4 fois. (voir les figures [[figure 3][3]], [[figure 5][5]] et [[figure
     6][6]])

     Alors que pour un *Linux Natif*, qui ne supporte pas **AVX** au passage,
...
*** Test
    ...
    de la compilation du benchmark BT. (voir la [[figure a][figure 8]])
  
    Après avoir compilé et exécute le benchmark BT, la vectorisation au niveau du programme est représentée
    dans la figure suivante. (voir la [[figure b][figure 9]])
    ...
    Les figures suivantes représentent l'évaluation de la vectorisation au niveau du benchmark BT avec 8 threads. (voir la [[figure c][figure 10]])
...
* Annexe
  ...
  <<figure 2>>
  #+CAPTION: Résultat du backend IEEE (Machine Virtuelle)
  #+NAME: fig:res_vm_ieee
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_ieee.png]]

  <<figure 3>>
  #+CAPTION: Ecart type du backend IEEE (Machine Virtuelle)
  #+NAME: fig:stddev_vm_ieee
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_ieee_stddev.png]]

  <<figure 4>>
  #+CAPTION: Résultat du backend VPREC (Machine Virtuelle)
  #+NAME: fig:res_vm_vprec
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_vprec.png]]

  <<figure 5>>
  #+CAPTION: Ecart type du backend VPREC avec des nombres normaux (Machine Virtuelle)
  #+NAME: fig:stddev_vm_vprec_normal_stddev
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_vprec_normal_stddev.png]]

  <<figure 6>>
  #+CAPTION: Ecart type du backend VPREC avec des nombres dénormaux (Machine Virtuelle)
  #+NAME: fig:stddev_vm_vprec_denormal_stddev
  #+ATTR_LATEX: :width 450px
  [[../ressources/vm_vprec_denormal_stddev.png]]

  <<figure 7>>
  #+CAPTION: Résultat du backend VPREC entre l'implémentation sérial et l'implémentation vectorielle des nombres normaux (Machine Virtuelle)
  ...
  <<figure b>>
  #+CAPTION: Vectorisation au niveau du benchmark BT
  #+NAME: fig:Résume BT benchmark
  #+ATTR_LATEX: :width 450px
  ...
  <<figure 11>>
  #+CAPTION: Résultat du backend IEEE (Linux Natif)
  #+NAME: fig:res_laptop_ieee
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_ieee.png]]

  #+CAPTION: Ecart type du backend IEEE (Linux Natif)
  #+NAME: fig:stddev_laptop_ieee
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_ieee_stddev.png]]

  #+CAPTION: Résultat du backend VPREC (Linux Natif)
  #+NAME: fig:res_laptop_vprec
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_vprec.png]]

  #+CAPTION: Ecart type du backend VPREC avec des nombres normaux (Linux Natif)
  #+NAME: fig:stddev_laptop_vprec_normal_stddev
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_vprec_normal_stddev.png]]

  #+CAPTION: Ecart type du backend VPREC avec des nombres dénormaux (Linux Natif)
  #+NAME: fig:stddev_laptop_vprec_denormal_stddev
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_vprec_denormal_stddev.png]]

  #+CAPTION: Résultat du backend VPREC entre l'implémentation sérial et l'implémentation vectorielle des nombres normaux (Linux Natif)
  #+NAME: fig:res_laptop_vprec_vs
  #+ATTR_LATEX: :width 450px
  [[../ressources/laptop_vprec_serial_vs_vector.png]]
