...
et 3 bit de pseudo-mantisse). Prenons \hyperref[org6ad9228]{la formule du standard \textbf{IEEE754}} qui
est:
...
Voir la \hyperref[org9d96a0f]{figure 1}.
...
\label{sec:org50020e0}
\begin{enumerate}
\item Cas des nombres normaux
\label{sec:orgcfb1f85}
...
\label{sec:org724bfbd}
\begin{enumerate}
\item Ecart type
\label{sec:orgb5d0465}

Bien que nous utilisions une machine virtuelle, nous pouvons voir que les
résultats sont assez stable excepté 3 ou 4 fois. (voir les figures \hyperref[org81f7fc4]{3}, \hyperref[org1b4a954]{5} et \hyperref[org4f063cf]{6})

\item Backend IEEE
\label{sec:orge664c12}

Pour ce qui concerne le backend \textbf{ieee} (voir la figure \hyperref[org0ee5c8f]{2}), nous avons une
...
\item Backend VPREC
\label{sec:orge3bca89}

Pour ce qui concerne le backend \textbf{vprec} (voir la figure \hyperref[orgab0214a]{4}), nous pouvons
...
\label{sec:orgff270b8}
\subsection{Introduction}
\label{sec:orgfe71225}
...
de la compilation du benchmark BT. (voir la \hyperref[org91bf7eb]{figure 8})

Après avoir compilé et exécute le benchmark BT, la vectorisation au niveau du programme est représentée
dans la figure suivante. (voir la \hyperref[org3c42d71]{figure 9})
...
Les figures suivantes représentent l'évaluation de la vectorisation au niveau du benchmark BT avec 8 threads. (voir la \hyperref[org1404390]{figure 10})
...
\caption{\label{fig:org9473ecf}Ecart type du backend IEEE}
\end{figure}
...
\caption{\label{fig:org2ce45fa}Résultat du backend VPREC}
\end{figure}
...
\caption{\label{fig:org94b803c}Ecart type du backend VPREC avec des nombres normaux}
\end{figure}
...
\caption{\label{fig:orgb940104}Ecart type du backend VPREC avec des nombres dénormaux}
\end{figure}
...
\caption{\label{fig:orgfdbf55a}Résultat du backend VPREC entre l'implémentation sérial et l'implémentation vectorielle des nombres normaux}
\end{figure}
...
\caption{\label{fig:org260623b}Rappel des cas spéciaux}
\end{figure}
...
\caption{\label{fig:orgbd8fdc9}Vectorisation au niveau du benckmark BT}
\end{figure}
...
\caption{\label{fig:org2a79be2}Vectorisation au niveau du benckmark BT}
\end{figure}
\end{document}
