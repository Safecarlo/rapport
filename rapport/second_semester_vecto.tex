...
intrinsèques qui seraient dépendantes de l'architecture. (réf: \hyperref[org086511e]{2})
...
\label{sec:org7a45133}
\subsection{Point git}
\label{sec:orgcfddd65}
\subsubsection{Rebasage}
\label{sec:org6a5484d}
...
et 3 bit de pseudo-mantisse). Prenons \hyperref[org8401a0b]{la formule du standard \textbf{IEEE754}} qui
est:
...
\label{sec:org39474f1}
\begin{enumerate}
\item Cas des nombres normaux
\label{sec:orgebc5142}
...
\label{sec:org7d0dc0e}
\subsubsection{Explication}
\label{sec:org9e0e66c}
\begin{enumerate}
\item But
\label{sec:org66d93b9}
...
\label{sec:org3c7bc55}
\subsection{Introduction}
\label{sec:org5ac5f4a}
...
de la compilation du benchmark BT. (voir la \hyperref[org004c21c]{figure 8})

Après avoir compilé et exécute le benchmark BT, la vectorisation au niveau du programme est représentée
dans la figure suivante. (voir la \hyperref[org451b01f]{figure 9})
...
Les figures suivantes représentent l'évaluation de la vectorisation au niveau du benchmark BT avec 8 threads. (voir la \hyperref[org5e703af]{figure 10})
